    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <Button class="redbtn" >Welcome</Button>
                <Button class="redbtn" onclick="openpart('myaccount')"> My Account</Button>
                <Button class="redbtn" onclick="openpart('requestgame')"> Request Game</Button>
                <Button class="redbtn" onclick="openpart('issuereport')"> Game Report</Button>
            ...
            <Button class="redbtn" >ISSUE RECORD</Button>
            ...
            $u=new data;
            $u->setconnection();
            $u->getissuegame($userloginid);
            $recordset=$u->getissuegame($userloginid);

            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style='  border: 1px solid #ddd;
            padding: 8px;'>Name</th><th>Game Name</th><th>Issue Date</th><th>Return Date</th><th>Fine</th></th><th>Return</th></tr>";
            ...
            <Button class="redbtn" >Return Game</Button>

            <?php

            $u=new data;
            $u->setconnection();
            $u->returngame($returnid);
            $recordset=$u->returngame($returnid);
                ?>
            ...
            <div class="rightinnerdiv">   
            <div id="requestgame" class="innerright portion" style="<?php  if(!empty($_REQUEST['returnid'])){ $returnid=$_REQUEST['returnid'];echo "display:none";} else {echo "display:none"; }?>">
            <Button class="redbtn" >Request Game</Button>
            ...
            <th>Image</th><th>Game Name</th><th>Game Author</th><th>branch</th><th>price</th></th><th>Request Game</th></tr>";
            ...
            foreach($recordset as $row){
               ...
               $table.="<td>$row[2]</td>";
                ...
                $table.="<td>$row[6]</td>";
                $table.="<td>$row[7]</td>";
                $table.="<td><a href='requestgame.php?gameid=$row[0]&userid=$userloginid'><button type='button' class='btn btn-primary'>Request Game</button></a></td>";
